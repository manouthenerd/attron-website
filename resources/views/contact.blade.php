...
<main class="mt-4">
    ...
    <div class="w-full max-w-lg my-0 mx-auto">
        ...
        <div class="bg-[#BDCEBD] p-4 rounded-sm">
           {{ $message ?? 'Nous vous contacterons dès réception de votre message.'}} 
        </div>
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="mb-4">
                ...
                <input
                    ...
                    id="username" name="username" type="text" placeholder="Marc Arthur">
            </div>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    id="contact" name="contact" type="password" placeholder="+225012030405">
            </div>
            <div class="mb-6">
                ...
                <input
                    class="shadow appearance-none border border-gray-100 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                    id="email" type="email" name="email" placeholder="contact@gmail.com">
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea
                    class="h-[150px] shadow appearance-none border border-gray-100 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                    id="message" placeholder="Veuillez exprimer votre besoin ici...">
            </textarea>
            </div>
