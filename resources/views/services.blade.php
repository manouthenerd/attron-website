...
<main class="grid place-content-center p-2">
    ...
    <section class="mt-[20px] flex justify-center flex-wrap gap-[6.5rem]">
        <x-card title="Formation financière" img="finance.jpg">
        ...
        <x-card title="Marketing" img="finance.jpg">
        ...
        <x-card title="Finance et fiscalité" img="finance.jpg">
        ...
        <x-card title="Création d'entreprises" img="finance.jpg">
        ...
        <x-card title="Représentation de marques" img="finance.jpg">
            Notre service de représentation de marque vous aide à façonner et à défendre l'image de votre entreprise
            auprès de vos clients et partenaires. Grâce à des stratégies de communication ciblées et des actions sur
            mesure, nous veillons à ce que votre marque se distingue, soit reconnue et génère une véritable connexion
            avec votre public.
        </x-card>

        <x-card title="Conseils en management" img="finance.jpg">
        ...
        <x-card title="Recherche de partenaires" img="finance.jpg">
        ...
        <x-card title="Formation continue" img="finance.jpg">
            Notre service de formation continue vous offre des programmes adaptés pour développer les compétences de vos
            équipes et maintenir leur expertise à jour. Que ce soit pour renforcer des compétences spécifiques ou pour
            accompagner l’évolution professionnelle, nous vous proposons des solutions flexibles et personnalisées qui
            répondent aux besoins de votre organisation et de vos collaborateurs
        </x-card>

        <x-card title="Ventes et Achates de fournitures de bureau" img="finance.jpg">
